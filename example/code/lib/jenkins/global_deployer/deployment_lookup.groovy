...
dts = groovy.json.JsonOutput.toJson(DEPLOYMENT_TARGETS.split(","))
logger.info("DTS: " + dts)

try {
    List<String> resultArray = new ArrayList<String>()
    url = 'http://qairon:5001/api/rest/v1/deployment?q={"filters":[{"name":"deployment_target_id","op":"in","val":'+ dts + '}]}'
    logger.info("URL: " + url)

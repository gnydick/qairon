...
alter table deployment drop constraint deployment_deployment_target_bin_id_fkey;
...
alter table deployment_target_bin drop constraint deployment_target_bin_deployment_target_id_fkey;
...
alter table stack_config drop constraint stack_config_config_template_id_fkey;
alter table stack_config drop constraint stack_config_stack_id_fkey;
...
alter table target_bins_fleets drop constraint target_bins_fleets_deployment_target_bin_id_fkey;
alter table target_bins_fleets drop constraint target_bins_fleets_fleet_id_fkey;

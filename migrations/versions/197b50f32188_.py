...
Revision ID: 197b50f32188
Revises: None
Create Date: 2026-01-10 01:17:09.147079

"""

# revision identifiers, used by Alembic.
revision = '197b50f32188'
down_revision = None
...
def schema_upgrades():
    ...
    sa.Column('last_updated_at', sa.DateTime(), nullable=True),
    sa.Column('name', sa.String(), nullable=False),
    sa.ForeignKeyConstraint(['dependency_case_id'], ['plugin_dependencies_dependency_case.id'], ),
    sa.ForeignKeyConstraint(['relatable_id'], ['plugin_dependencies_relatable.id'], ),
    sa.PrimaryKeyConstraint('id'),
    ...
    sa.Column('id', sa.String(), nullable=False),
    sa.Column('name', sa.String(), nullable=False),
    sa.Column('repo_type_id', sa.String(), nullable=False),
    sa.Column('created_at', sa.DateTime(), server_default=sa.text('now()'), nullable=False),
    sa.Column('last_updated_at', sa.DateTime(), nullable=True),
    ...
    sa.Column('created_at', sa.DateTime(), server_default=sa.text('now()'), nullable=False),
    sa.Column('last_updated_at', sa.DateTime(), nullable=True),
    sa.ForeignKeyConstraint(['dependency_id'], ['plugin_dependencies_dependency.id'], ),
    sa.PrimaryKeyConstraint('id')
    )
    ...
    op.create_index('ix_services_repos_to_repo_id', 'services_repos', ['repo_id'], unique=False)
    op.create_index('ix_services_repos_to_service_id', 'services_repos', ['service_id'], unique=False)
    ...
    sa.Column('id', sa.String(), nullable=False),
    sa.Column('deployment_target_type_id', sa.String(), nullable=False),
    ...
    op.create_index(op.f('ix_deployment_target_native_id'), 'deployment_target', ['native_id'], unique=False)
    ...
    sa.Column('service_id', sa.String(), nullable=False),
    sa.Column('current_release_id', sa.String(), nullable=False),
    sa.Column('created_at', sa.DateTime(), server_default=sa.text('now()'), nullable=False),
    sa.Column('last_updated_at', sa.DateTime(), nullable=True),
    sa.Column('tag', sa.String(), nullable=False),
    sa.Column('defaults', sa.Text(), nullable=True),
    ...
    sa.Column('id', sa.String(), nullable=False),
    sa.Column('deployment_target_id', sa.String(), nullable=False),
    sa.Column('fleet_type_id', sa.String(), nullable=False),
    sa.Column('native_id', sa.String(), nullable=True),
    sa.Column('created_at', sa.DateTime(), server_default=sa.text('now()'), nullable=False),
    sa.Column('last_updated_at', sa.DateTime(), nullable=True),
    ...
    sa.Column('id', sa.String(), nullable=False),
    sa.Column('config_template_id', sa.String(), nullable=False),
    ...
    sa.Column('id', sa.String(), nullable=False),
    sa.Column('deployment_id', sa.String(), nullable=False),
    sa.Column('proc_id', sa.String(), nullable=False),
    sa.Column('created_at', sa.DateTime(), server_default=sa.text('now()'), nullable=False),
    sa.Column('last_updated_at', sa.DateTime(), nullable=True),
    sa.Column('defaults', sa.Text(), nullable=True),
    sa.ForeignKeyConstraint(['deployment_id'], ['deployment.id'], ),
    ...
    op.create_table('target_fleets',
    sa.Column('deployment_target_id', sa.String(), nullable=False),
    sa.Column('fleet_id', sa.String(), nullable=False),
    sa.ForeignKeyConstraint(['deployment_target_id'], ['deployment_target.id'], ),
    sa.ForeignKeyConstraint(['fleet_id'], ['fleet.id'], )
    )
    op.create_index('ix_target_to_fleets_deployment_target_id', 'target_fleets', ['deployment_target_id'], unique=False)
    op.create_index('ix_target_to_fleets_fleet_id', 'target_fleets', ['fleet_id'], unique=False)
    op.create_table('allocation',
    sa.Column('id', sa.String(), nullable=False),
    sa.Column('value', sa.Float(), nullable=False),
    sa.Column('allocation_type_id', sa.String(), nullable=False),
    sa.Column('deployment_proc_id', sa.String(), nullable=False),
...
def schema_downgrades():
    ...
    op.drop_index('ix_target_to_fleets_fleet_id', table_name='target_fleets')
    op.drop_index('ix_target_to_fleets_deployment_target_id', table_name='target_fleets')
    op.drop_table('target_fleets')
    ...
    op.drop_index(op.f('ix_deployment_target_native_id'), table_name='deployment_target')
    ...
    op.drop_table('zone')
    op.drop_index('ix_services_repos_to_service_id', table_name='services_repos')
    op.drop_index('ix_services_repos_to_repo_id', table_name='services_repos')

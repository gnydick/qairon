...
./qairon_qcli/qcli.py application create app
./qairon_qcli/qcli.py stack create app cicd
./qairon_qcli/qcli.py stack create app automation
./qairon_qcli/qcli.py service create app:automation qairon
./qairon_qcli/qcli.py service create app:cicd  jenkins -d '{
   "releases":{
      "helm":{
         "repo":"jenkins",
         "artifact":"jenkins"
...
./qairon_qcli/qcli.py deployment create app:automation:qairon infra:aws:126252960572:us-west-2:vpc0:eks:infra0

# CICD data
# builds -- immutable blobs from build pipeline
./qairon_qcli/qcli.py build create app:automation:qairon 422 v0.1
./qairon_qcli/qcli.py build create app:automation:qairon 564 v0.2
./qairon_qcli/qcli.py build create app:cicd:jenkins 456 v1.0
./qairon_qcli/qcli.py build create app:cicd:jenkins 567 v1.1

./qairon_qcli/qcli.py build_artifact create app:automation:qairon:422 git:qairon ecr:qairon docker_image foobarbaz
...
./qairon_qcli/qcli.py release create app:automation:qairon:422 infra:aws:126252960572:us-west-2:vpc0:eks:infra0:app:automation:qairon:default 1023
./qairon_qcli/qcli.py release create app:automation:qairon:564 infra:aws:126252960572:us-west-2:vpc0:eks:infra0:app:automation:qairon:default 1104
./qairon_qcli/qcli.py release_artifact create infra:aws:126252960572:us-west-2:vpc0:eks:infra0:app:automation:qairon:default:1104 ecr:qairon helm:qairon helm_chart foobarbaz
